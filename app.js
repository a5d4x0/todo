...
//数据集合
var todos = [
    { id: 1, task: 'The first task', status: 'wait', tags: [{name: 'study'}, {name: 'game'}], date: '2016-4-17'},
    { id: 2, task: 'The second task', status: 'doing', tags: [{name: 'study'}, {name: 'game'}], date: '2016-4-18'},
    { id: 3, task: 'The third task', status: 'done', tags: [{name: 'study'}, {name: 'game'}], date: '2016-4-19'}
];
...
//修改单个todo（部分）
app.patch('/api/todos/:id', function (req, res, next) {
    let searchTodo = todos.filter(todo => todo.id == req.params.id)[0];
